        ...
        <div class="details">
          <div class="recentTests">
            ...
            <div class="form-add-exam">
                <form action="/Project/admin/exam?action=add" method="post">
                  <div class="form-body">
                    ...
                    <div class="form-group">
                      ...
                      <select name="status" id="status">
                        ...
                        <option value="COMPLETED" class="${exam.getStatus()}">Kết thúc</option>
                    </select>
                    </div>
                    <div class="group-btn">
                      <a href="/Project/admin/exam">
                      ...
                      <button class="btn btn-add_2">Thêm mới</button>
                    </div>
                  </div>
                </form>
              </div>
    ...
    <script>
      $(document).ready(function() {
              $('form').submit(function(e) {
                  ...
                  console.log(formData.name, formData.dateStart, formData.dateEnd, formData.status)

                  $.ajax({
                      type: 'POST',
                      url: '/Project/admin/exam?action=add',
                      data: formData,
                  })
                  .done(function(data) {
