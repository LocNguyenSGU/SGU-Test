...
<li>
        ...
        <div class="details">
          <div class="recentTests">
            ...
            <div class="form-add-exam">
                <form action="/Project/admin/subject?action=update" id="myForm" method="post" >
                  <div class="form-body">
                                          <input class="create_student_input" type="hidden" name="subjectID" id="name" value="${Subject.getSubjectID()}"><br>
                                          <label for="name">Tên Môn Học</label><br>
                                          <input class="create_student_input" type="text" name="namesubject" id="name" value="${Subject.getName()}"><br>
                    </div>
                     <div class="form-body">

                                                              <label for="email">Mô Tả</label><br>
                                                              <textarea id="message" name="descrpition" style="font-size:20px;" rows="4" cols="58">${Subject.getDescription()}
                                                                      </textarea><br>
                                        </div>
                    <div class="form-group">
                      <label for="MajorID">Chuyên Ngành </label><br>
                       ...
                       <c:forEach var="major" items="${Majors}">
                         <option style="padding:5px;height:40px"  ${Subject.getMajorID() == major.getMajorID() ? 'selected' : ''} value="${major.getMajorID()}">${major.getName()}</option>
                        </c:forEach>
                        </select>
                     </div>
                    <div class="group-btn">
   ...
   $(document).ready(function() {
                   ...
                   let idsubject = document.querySelector('input[name="subjectID"]');
                   ...
                   if(!MajorId.value.trim()){
                       ...
                       return;
                                 ...
                                 $.ajax({
                                     type: 'POST',
                                     url: '/Project/admin/subject?action=update',
                                     data: formData,
