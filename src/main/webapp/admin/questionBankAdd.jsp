        ...
        <div class="topbar">
          ...
          <!-- <div class="search">
            <label>
              <input
                type="text"
                placeholder="Nhập nội dung câu hỏi cần tìm kiếm"
                name="search"
              />
        ...
        <div class="details">
          <div class="recentTests">
            <div class="cardHeader">
              <h2>Thêm câu hỏi</h2>
              <form id="uploadForm" action="/Project/admin/questionbank?action=addbyexcel" method="POST" enctype="multipart/form-data">
                <input type="file" id="fileInput" style="display: none;" name="file_excel" />
                <button type="button" class="btn-excel" id="excelButton">
              ...
              <div class="body-edit">
                <div class="sub-body-edit">
                  <div class="question">
                    ...
                    ><br />
                    <textarea name="title" id="title" cols="30" rows="10"  placeholder="Nhập nội dung ở đây...">
Nội dung câu hỏi</textarea
    ...
    <script>
      let idRandomOption1 = randomId();
      let idRandomOption2 = randomId();
      let idRandomQuestion = randomId();
      const infoEmployeeLocal = localStorage.getItem("info");
      const infoEmployee = JSON.parse(infoEmployeeLocal);
      console.log(infoEmployee.EmployeeID);
      let questionDetail = {"QuestionID":idRandomQuestion,"Title":"","Point":9.5,"CorrectAnswer":idRandomOption1,"Level":"EASY","EmployeeID":infoEmployee.EmployeeID,"SubjectID":1,"employee":{"EmployeeID":infoEmployee.EmployeeID,"FirstName":null,"LastName":null,"MajorID":null,"RoleID":null},"subject":{"SubjectID":1,"Name":'Toán cao cấp',"MajorID":0},"options":[{"OptionID":idRandomOption1,"Title":"Nhập nội dung lựa chọn","QuestionID":idRandomQuestion},{"OptionID":idRandomOption2,"Title":"Nhập nội dung lựa chọn","QuestionID":idRandomQuestion}]}
    ...
    function updateQuestion() {
        ...
        console.log(questionDetail);
        $.ajax({
            url: "/Project/admin/questionbank?action=add",
            type: "POST",
            data: {
