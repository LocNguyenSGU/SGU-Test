...
<%
  ...
  int testID = isEmpty ? 0 : results.get(0).getTestID();
  int[] studentIDs = new int[results.size()];
  
  for (int i = 0; i < results.size(); i++) {
    studentIDs[i] = results.get(i).getStudentID();
  }
%>
...
<body>
  ...
  <main class="main">
    ...
    <section class="student-mana">
      <header class="student-mana__header">
        <h2 class="heading-secondary">Kết quả Bài thi</h2>
      </header>
  ...
  ></script>
   ...
   <script>
       ...
       studentIDs = [<%= java.util.Arrays.toString(studentIDs).replaceAll("\\[|\\]", "") %>];
       testID = <%= testID %>;
   </script>
   <script src="https://unpkg.com/xlsx/dist/xlsx.full.min.js"></script>
   <script src="../../assets/js/instructor/instructor.js"></script>
   <script type="module" src="../../assets/js/instructor/test-results.js"></script>
